...
public class LambdaFormFunctionHandler implements
	...
	public Object handleRequest(Object input, Context context) {
		...
		PutItemResult putItemResult= dynamoDB.putItem(new PutItemRequest("OfficeEmployee",
								  this.newItem(mapInput.get("employee_id"),mapInput.get("employee_name"),
								  mapInput.get("expense_type"),mapInput.get("amount"))));

		context.getLogger().log("Put reesult="+putItemResult);
		return "{'status':'done'}";
	}
